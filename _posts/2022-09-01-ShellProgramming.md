...
The task was to create a shell that can handle up to 5 pipes. Hard coding each 1,2,3,4, and 5 cases for piping wasn't the best practice. The logic should be changed to support many number of pipes without limits.